sprite_change_offset("idle", 25, 46);
sprite_change_offset("hurt", 0, 0);
sprite_change_offset("crouch", 0, 0);
sprite_change_offset("walk", 26, 44);
sprite_change_offset("walkturn", 25, 44);
sprite_change_offset("dash", 25, 44);
sprite_change_offset("dashstart", 25, 44);
